...
pin: true
description: >-
  ytpi is a lightweight Flask app that automates YouTube and playlist downloads to
  your home server or Raspberry Pi — with a live dashboard and LAN-only access.
